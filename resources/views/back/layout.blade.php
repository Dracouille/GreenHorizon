...
<head>
  ...
  <title>Admin | Green Horizon</title>
  ...
  <link rel="stylesheet" href="{{asset('AdminLTE/css/Perso.css')}}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('AdminIndex')}}" class="logo">
      ...
      <span class="logo-mini"><b>GrH</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Green Horizon</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">{{ $notif }} commentaires en attente</li>
              <li>
                <!-- Inner Menu: contains the notifications -->
                <ul class="menu">
                  <li><!-- start notification -->
                    <a href="{{route('ComAValider')}}">
                      <i class="fa fa-users text-aqua"></i> Voir les commentaires non lus
                    </a>
                  </li>
                  <!-- end notification -->
                </ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-">
                <div class="pull-left">
                  <a href="{{ route('NameLogout') }}" class="btn btn-default btn-flat">Déconnexion</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; Antonin Damerval
  </footer>
